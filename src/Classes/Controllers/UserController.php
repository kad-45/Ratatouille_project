...
class UserController extends AbstractController {
  ...
  public function index() {
      if ((Service::ifUserIsConnected()) && (isset($_SESSION['role']) && $_SESSION['role'] === ROLE_ADMIN)) {
...
$errors = [];
$fields = ['lastname'=>['validRequired'], 'firstname'=>['validRequired'], 'email'=>['validEmail'],
...
$newUser = new User($user['lastname'], $user['firstname'], $user['email'], $user['role'], $user['created_at'],
$updateAt->format('Y-m-d H:s:i'));
$newUser->setActif(0);
...
echo "<div class='alert-success' style='background:green; item-align: center; font-size:16px;>Vous êtes connecté</div>";
  ...
  style='background:red; padding-top:10px;color:white; text-align: center; margin-left:36%; width:400px; height:40px; font-size:16px;'>
